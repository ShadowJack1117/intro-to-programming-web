...
function getBPM() {
    //I Get the timestamp for NOW and save it in a variable
    let date_right_now = Date.now();
    // Add that new timestamp to the array
    clicks.push(date_right_now);
    //I Check if the length of the array is equal to or greater than min_clicks (10) - if yes, calculate!
    ...
    //I Bring up an alert that tells the user the BPM that was calculated
